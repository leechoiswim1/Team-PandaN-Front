...
const ProjectModal = () => {
  ...
  return (
    <>
      <IconProjectAdd width="40" height="40" fill="#9A9A9A" className="menu-icon" onClick={() => setLgShow(true)} />
      ...
      <Modal show={lgShow} onHide={() => setLgShow(false)} aria-labelledby="example-custom-modal-styling-title">
        <Modal.Header closeButton>
          <div style={{ display: "flex", height: "25px" }}>
            ...
            <Modal.Title style={{ fontWeight: "700", color: "#000000", fontSize: "15px" }}>프로젝트 생성하기</Modal.Title>
          </div>
        </Modal.Header>
        ...
        <Modal.Body>
          <form style={{ margin: "1vh 3vw 2vh 3vw" }}>
            ...
            <p style={{ color: "#9A9A9A", fontSize: "7px", fontWeight: "200" }}>팀원들이 작업환경에 대해 쉽게 알 수 있도록 작성해주세요.</p>
          </form>
        </Modal.Body>
        <Modal.Footer>
          <MakeP
